...
REGION             = 'us-central1'
PIPELINE_NAME      = 'ml-in-the-cloud-course-stackoverflow-nlp-vertex-trainer'
...
MODULE_FILE        = 'gs://ml-in-the-cloud-vertex-us/tfx-pipeline/stackoverflow_utils_vertex_trainer.py'
...
runner = tfx.orchestration.experimental.KubeflowV2DagRunner(
    ...
    output_filename='pipeline_vertex_trainer.json')
...
_ = pipelines_client.create_run_from_job_spec('pipeline_vertex_trainer.json')